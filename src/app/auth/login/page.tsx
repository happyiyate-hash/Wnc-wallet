...
import { Loader2, ShieldCheck, Mail, Lock, LogIn, AlertCircle, ArrowRight } from 'lucide-react';
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-white/40 uppercase tracking-widest px-2">Node Password</Label>
              <div className="relative group">
