    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#050505] p-6 text-foreground">
      ...
      >
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight uppercase">Verify Node</h1>
          <p className="text-sm text-muted-foreground leading-relaxed">
            A verification handshake was sent to <br/>
        ...
        <form onSubmit={handleVerify} className="space-y-6">
          ...
          >
            {isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Confirm Authority"}
          </Button>
        </form>
