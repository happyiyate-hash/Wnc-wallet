...
function ReceiveClient() {
  ...
  useEffect(() => {
    ...
    const initial = allAssets.find(a => a.chainId === viewingNetwork.chainId && a.isNative) || 
    ...
    <div className="flex flex-col h-screen bg-transparent">
      <header className="p-4 flex items-center justify-between border-b border-white/5 bg-black/20 backdrop-blur-2xl sticky top-0 z-50 px-6">
        ...
        <button 
            ...
            className="flex flex-col items-center text-center px-4 py-1 hover:bg-white/5 rounded-2xl transition-all"
        >
