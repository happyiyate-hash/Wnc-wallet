...
/**
 * LOGO & METADATA SUPABASE CLIENT
 * 
 * Dedicated instance for fetching global token registries and direct logo URLs.
 * This is a separate project from the main application auth/wallet storage.
 */
