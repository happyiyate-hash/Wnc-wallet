...
/**
 * GLOBAL LOADING BARRIER (SWR Optimized)
 * Only blocks the screen if there is absolutely no cached identity data.
 * If cached data exists, it yields instantly to allow for background revalidation.
 */
export default function GlobalLoadingBarrier() {
  ...
  // 1. SWR LOGIC: If we have a cached profile, don't block the UI
  // The WalletProvider will fill in the addresses and balances from localStorage.
